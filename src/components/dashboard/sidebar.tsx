...
// ─────────────────────────────────────────────────────────────
// Sidebar navigation — client component because it reads the
// current pathname for the active-link highlight.
// ─────────────────────────────────────────────────────────────
      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              <span
                className={cn(isActive ? "text-brand-600" : "text-slate-400")}
              >
                {item.icon}
              </span>
              {item.label}
